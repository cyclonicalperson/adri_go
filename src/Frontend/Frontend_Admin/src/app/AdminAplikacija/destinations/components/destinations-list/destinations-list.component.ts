...
export class DestinationsListComponent implements OnInit {
  ...
  goNew(): void { this.router.navigate(['/admin/destinations/new']); }
  goEdit(d: Destination): void { this.router.navigate(['/admin/destinations', d.destinationId, 'edit']); }
  goDetail(d: Destination): void { this.router.navigate(['/admin/destinations', d.destinationId]); }

  confirmDelete(d: Destination): void { this.deleteTarget = d; }
